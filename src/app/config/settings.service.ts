...
{
	private _settingsSub$: BehaviorSubject<AppSettings | null> = new BehaviorSubject<AppSettings | null>(null);
	readonly appSettings$ = this._settingsSub$.asObservable();
	...
	initialize()
	{
		...
		{
			this._httpClient.get<AppSettings>("assets/app.config.json").pipe(
